...
pathDat <- Arguments$getReadablePathname("../data/extdata_Crimmix/Data_sim_20181012")
pathMeth <- Arguments$getReadablePathname("../data/extdata_Crimmix/Data_Results_20181012")
