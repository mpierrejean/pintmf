...
test <- do.call(rbind, lapply(1:10, function (ii){
  ...
  return(list(sim=ii,mclust::adjustedRandIndex(clust_function(R), true.clusters), 
              mclust::adjustedRandIndex(clust_function(R_svd), true.clusters), mclust::adjustedRandIndex(clust_function(R_random), true.clusters), mclust::adjustedRandIndex(clust_function(R_hclust), true.clusters)))
}))
```
